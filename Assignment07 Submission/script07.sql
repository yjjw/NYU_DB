...
-- ANSWER4
CREATE TABLE TEMP4
AS SELECT DISTINCT DOMAIN_NAME
FROM COMPANY_DOMAIN
WHERE TIN = '99448276';

CREATE TABLE TEMP5
AS SELECT DISTINCT TEMP4.DOMAIN_NAME, TIN
FROM TEMP4, COMPANY_DOMAIN;

CREATE TABLE TEMP6
AS SELECT * FROM TEMP5
MINUS
...
AS SELECT DISTINCT TIN FROM COMPANY_DOMAIN
MINUS
SELECT DISTINCT TIN FROM TEMP7
ORDER BY TIN ASC;
